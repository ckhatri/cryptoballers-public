window.App = {
  ...
  // our smart contract address
    ...
    BallerToken.getTeamsOfOwner(web3.eth.accounts[0], function(error, results) {
      if (error) {
      ...
      for (var a = 0; a < count; a += 3) {
        ...
        rowHTML = rowHTML.concat([
            ...
            teamNames.indexOf(teamNames[results[a]['c']]),
            '\"><div class=\"view overlay\"><img class=\"img-fluid\" src=\"',
            'img/' + teamNames[results[a]['c']] + '.png',
        ...
        if (a + 1 < count) {
          rowHTML = rowHTML.concat([
              '<div class=\"card mb-4 col-4\" id=\"',
                teamNames.indexOf(teamNames[results[a+1]['c']]),
              '\"><div class=\"view overlay\"><img class=\"img-fluid\" src=\"',
              'img/' + teamNames[results[a+1]['c']] + '.png',
              '\" alt=\"Card image cap\"></div><div class=\"card-body text-center\"><h4 class=\"card-title\">',
              '</h4><p class=\"card-text\">',
              '',
              '</p><button type=\"button\" class=\"btn btn-elegant btn-md\">',
        ...
        if (a + 2 < count) {
          rowHTML = rowHTML.concat([
              '<div class=\"card mb-4 col-4\" id=\"',
              teamNames.indexOf(teamNames[results[a+2]['c']]),
              '\"><div class=\"view overlay\"><img class=\"img-fluid\" src=\"',
              'img/' + teamNames[results[a+2]['c']] + '.png',
              '\" alt=\"Card image cap\"></div><div class=\"card-body text-center\"><h4 class=\"card-title\">',
              '</h4><p class=\"card-text\">',
              '',
              '</p><button type=\"button\" class=\"btn btn-elegant btn-md\">',
        ...
        var index = teamNames.indexOf(teamNames[results[a]['c']])
    		$('.teamCards').find('#' + index).find('h4')[0].innerText = teamNames[results[a]['c']];
